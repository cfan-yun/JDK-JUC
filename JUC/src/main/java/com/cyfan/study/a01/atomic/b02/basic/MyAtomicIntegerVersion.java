...
public class MyAtomicIntegerVersion extends Number implements java.io.Serializable {
    ...
    private  static final class ValueVersion{//value添加版本号
        private volatile int value;

        private volatile int version;

        private ValueVersion(int value, int version){
            this.value = value;
    ...
    static {
        try {
            ...
            valueVersionOffset = unsafe.objectFieldOffset
                    (MyAtomicIntegerVersion.class.getDeclaredField("valueVersion"));
...
//    private volatile int version;
    ...
    private volatile ValueVersion valueVersion;
     ...
     */
    public MyAtomicIntegerVersion(int initialValue, int initialVersion) {
//        value = initialValue;
     ...
     */
    public MyAtomicIntegerVersion() {
        this.valueVersion = new ValueVersion(0, 0);
    }
    ...
    public final void lazySet(int newValue) {
        unsafe.putOrderedInt(this.valueVersion, valueOffset, newValue);
    }
    ...
    public final int getAndSet(int newValue) {
        return unsafe.getAndSetInt(this.valueVersion, valueOffset, newValue);
    }
    ...
    public final boolean compareAndSet(int expect, int update) {
        return unsafe.compareAndSwapInt(this.valueVersion, valueOffset, expect, update);
    }

    public final boolean compareAndSet(int expectValue, int newValue, int exceptVersion, int newVersion) {
