package com.cyfan.juc.my.test.threadPool.queue;
 ...
 * 模拟使用无界队列造成的内存泄露
 */
public class LinkedBlockingDequeForOOM {

    public static void main(String[] args) {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(3, 10, 0, TimeUnit.SECONDS, new LinkedBlockingDeque<>());
