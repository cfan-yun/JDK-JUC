package com.cyfan.juc.my.study;
...
public class MyCompletableFutureDemo {
    private static final ThreadPoolExecutor EXECUTOR = new ThreadPoolExecutor(5,10,3L, TimeUnit.MILLISECONDS, new LinkedBlockingDeque<>());
